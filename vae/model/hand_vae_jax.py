"""Flax implementation of the hand-action VAE."""
...
class CausalConv1d(nn.Module):
    """1D convolution with explicit left padding."""
...
class MLPEncoder(nn.Module):
    ...
    def setup(self) -> None:
        ...
        self.layers = [TorchDense(dim, name=f"layer_{idx}") for idx, dim in enumerate(layer_dims)]
