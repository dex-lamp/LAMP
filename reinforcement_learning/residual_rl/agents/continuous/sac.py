...
from reinforcement_learning.residual_rl.common.encoding import EncodingWrapper
    ...
    def create_pixels(
        ...
        **kwargs,
        ...
        if "pretrained" in encoder_type:  # load pretrained weights for ResNet-10
            from reinforcement_learning.residual_rl.utils.train_utils import load_resnet10_params
