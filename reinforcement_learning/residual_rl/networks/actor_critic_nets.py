...
from reinforcement_learning.residual_rl.common.common import default_init
from reinforcement_learning.residual_rl.utils.jax_utils import append_dims, append_zero, extend_and_repeat
...
class ConsistencyPolicy(nn.Module):
    ...
    def __call__(
        ...
        obs_enc = self.encoder(observations, train=False)
